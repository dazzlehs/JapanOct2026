...
## เนื้อหาในหน้า
- แผนเส้นทางรายวันทั้ง 13 วัน แสดงแยกวันแบบเลื่อนอ่านยาว (ไม่ใช่แท็บสลับวันแล้ว) — แต่ละวันแบ่งซ้าย/ขวา: ซ้ายเป็นการ์ดสรุปสถานที่ไฮไลต์ของวันนั้น ขวาเป็นตารางเวลา+ทิป มีแถบตัวเลขวันที่ด้านบนไว้กระโดดไปวันที่ต้องการ
- ชื่อสถานที่ทุกจุดคลิกเปิด Google Maps ได้ทันที
